...
/* =============================================================
   ADDITIONS to assets/js/translation.js — settings.html coverage
   -------------------------------------------------------------
   Merge each block below into its matching language object in
   the existing TRANSLATIONS dictionary. Two keys are new shared
   "common.*" entries (used on other pages too, e.g. modal close
   buttons) — if common.cancel or common.close already exist from
   an earlier page, skip the duplicate rather than overwriting.
   ============================================================= */
...
/* -------------------------------------------------------------
   Follow-ups needed in pages/settings.js
   -------------------------------------------------------------
   ...
   needs to be swapped for a MeridianI18n.t('key') call once the
   keys above are merged in:
   ...
   I'd rather flag all of these together than translate them now
   and have you juggle two merge points — let me know if you want
   me to go ahead and patch settings.js directly next.
   ------------------------------------------------------------- */
